...
function setup() {
	...
	roof = Bodies.rectangle(390, 100, 230, 20, options);
    World.add(world,roof);

	bob1 = Bodies.circle(305, 300, 20, options);
	World.add(world, bob1);
 
	bob2 = Bodies.circle(345, 300, 20, options);
	World.add(world, bob2);

	bob3 = Bodies.circle(385, 300, 20, options);
	World.add(world, bob3);

	bob4 = Bodies.circle(425, 300, 20, options);
	World.add(world, bob4);

    bob5 = Bodies.circle(465, 300, 20, options);
